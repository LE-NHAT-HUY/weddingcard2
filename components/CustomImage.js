    ...
    <div className="heart">
      <style jsx>{`
        .heart {
          ...
          top: 85px;
          left: 100px;
          background-image: url("https://w.ladicdn.com/s400x400/649340684a3700001217851c/rbg/dau-re-8-20250505092546-r95ta.png");
        ...
        @keyframes heartbeat {
          ...
          28% { transform: scale(1.3) rotate(0deg); }       /* phóng lớn */
